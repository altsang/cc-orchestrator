...
class TestInMemoryRateLimiter:
    ...
    def test_cleanup_old_entries(self):
        ...
        assert client_ip not in limiter.request_history or \
               endpoint not in limiter.request_history[client_ip] or \
               len(limiter.request_history[client_ip][endpoint]) == 0
