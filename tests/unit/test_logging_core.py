...
class TestStructuredFormatter:
    ...
    def test_format_basic_record(self, sample_log_record):
    ...
    def test_format_record_with_context(self, sample_log_record):
...
class TestLogContextAndLevels:
    ...
    def test_log_context_enum_values(self):
        ...
        expected_contexts = [
            "orchestrator", "instance", "task", "worktree",
            "web", "cli", "tmux", "integration", "database", "process"
        ]
