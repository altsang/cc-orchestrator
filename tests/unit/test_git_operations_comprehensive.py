...
class TestGitWorktreeManagerComprehensive:
    ...
    def test_repo_property_invalid_git_repository_error(self):
        ...
        with patch("cc_orchestrator.core.git_operations.Repo") as mock_repo_class:
            ...
            with pytest.raises(
                GitWorktreeError, match="Invalid git repository at /invalid/path"
            ):
                _ = manager.repo
    ...
    def test_list_worktrees_multiple_with_different_statuses(
        self, manager_with_mock_repo
    ):
...
"""
    ...
    def test_create_worktree_success_with_main_branch(
        self, manager_with_mock_repo, tmp_path
    ):
        ...
        with patch("cc_orchestrator.core.git_operations.Repo") as mock_repo_class:
            ...
            result = manager_with_mock_repo.create_worktree(
                path=worktree_path, branch="new-feature"
            )
            ...
            # Verify git commands
            manager_with_mock_repo.repo.git.show_ref.assert_called_with(
                "refs/heads/main"
            )
    ...
    def test_create_worktree_fallback_to_master_branch(
        self, manager_with_mock_repo, tmp_path
    ):
    ...
    def test_create_worktree_fallback_to_current_branch(
        self, manager_with_mock_repo, tmp_path
    ):
    ...
    def test_create_worktree_with_explicit_checkout_branch(
        self, manager_with_mock_repo, tmp_path
    ):
    ...
    def test_create_worktree_path_exists_no_force(
        self, manager_with_mock_repo, tmp_path
    ):
        ...
        with pytest.raises(GitWorktreeError, match="already exists"):
            manager_with_mock_repo.create_worktree(
                path=str(existing_path), branch="new-feature"
            )

    def test_create_worktree_path_exists_with_force(
        self, manager_with_mock_repo, tmp_path
    ):
        ...
        with patch("cc_orchestrator.core.git_operations.Repo") as mock_repo_class:
            ...
            result = manager_with_mock_repo.create_worktree(
                path=str(existing_path), branch="new-feature", force=True
            )
    ...
    def test_create_worktree_git_command_error(self, manager_with_mock_repo, tmp_path):
        ...
        with pytest.raises(GitWorktreeError, match="Failed to create worktree"):
            manager_with_mock_repo.create_worktree(
                path=worktree_path, branch="existing-feature"
            )

    def test_create_worktree_unexpected_exception(
        self, manager_with_mock_repo, tmp_path
    ):
    ...
    def test_remove_worktree_with_force(self, manager_with_mock_repo, tmp_path):
        ...
        with patch("cc_orchestrator.core.git_operations.Repo") as mock_repo_class:
            ...
            result = manager_with_mock_repo.remove_worktree(
                str(worktree_path), force=True
            )
    ...
    def test_remove_worktree_not_git_worktree_no_git_file(
        self, manager_with_mock_repo, tmp_path
    ):
    ...
    def test_remove_worktree_invalid_git_repository(
        self, manager_with_mock_repo, tmp_path
    ):
    ...
    def test_remove_worktree_cleanup_remaining_directory(
        self, manager_with_mock_repo, tmp_path
    ):
    ...
    def test_remove_worktree_cleanup_directory_fails(
        self, manager_with_mock_repo, tmp_path
    ):
    ...
    def test_remove_worktree_unexpected_exception(
        self, manager_with_mock_repo, tmp_path
    ):
    ...
    def test_cleanup_worktrees_only_main_repo(self, manager_with_mock_repo):
        ...
        with patch.object(
            manager_with_mock_repo, "list_worktrees", return_value=worktrees
        ):
            result = manager_with_mock_repo.cleanup_worktrees()
    ...
    def test_cleanup_worktrees_prune_error(self, manager_with_mock_repo):
        ...
        with (
            ...
            patch(
                "os.path.exists",
                side_effect=lambda path: path == manager_with_mock_repo.repo_path,
            ),
        ):
            manager_with_mock_repo.repo.git.worktree.side_effect = GitCommandError(
    ...
    def test_get_worktree_status_with_dirty_working_directory(
        self, manager_with_mock_repo, tmp_path
    ):
    ...
    def test_get_worktree_status_with_untracked_files(
        self, manager_with_mock_repo, tmp_path
    ):
    ...
    def test_get_worktree_status_with_staged_changes(
        self, manager_with_mock_repo, tmp_path
    ):
    ...
    def test_get_worktree_status_with_remote_tracking(
        self, manager_with_mock_repo, tmp_path
    ):
        ...
        with patch("cc_orchestrator.core.git_operations.Repo") as mock_repo_class:
            ...
            mock_worktree_repo.active_branch.tracking_branch.return_value = (
    ...
    def test_get_worktree_status_tracking_branch_error(
        self, manager_with_mock_repo, tmp_path
    ):
        ...
        with patch("cc_orchestrator.core.git_operations.Repo") as mock_repo_class:
            ...
            mock_worktree_repo.iter_commits.side_effect = GitCommandError(
                "iter_commits", 1, "error"
            )
    ...
    def test_get_worktree_status_invalid_git_repository_error(
        self, manager_with_mock_repo, tmp_path
    ):
    ...
    def test_get_worktree_status_unexpected_exception(
        self, manager_with_mock_repo, tmp_path
    ):
    ...
    def test_generate_worktree_path_no_conflicts(
        self, manager_with_mock_repo, tmp_path
    ):
    ...
    def test_generate_worktree_path_single_conflict(
        self, manager_with_mock_repo, tmp_path
    ):
    ...
    def test_generate_worktree_path_multiple_conflicts(
        self, manager_with_mock_repo, tmp_path
    ):
    ...
    def test_generate_worktree_path_with_pathlib(
        self, manager_with_mock_repo, tmp_path
    ):
