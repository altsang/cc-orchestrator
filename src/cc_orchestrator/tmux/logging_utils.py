...
def log_session_attach(session_name: str, instance_id: Optional[str] = None) -> None:
...
def log_session_detach(session_name: str, instance_id: Optional[str] = None) -> None:
