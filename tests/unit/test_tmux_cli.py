...
from cc_orchestrator.tmux import SessionInfo, SessionStatus
...
class TestTmuxCLI:
    ...
    def test_create_command_success(self, runner, mock_tmux_service, tmp_path):
        ...
        mock_tmux_service.create_session.side_effect = mock_create_session
    ...
    def test_create_command_invalid_env_format(
        self, runner, mock_tmux_service, tmp_path
    ):
    ...
    def test_destroy_command_success(self, runner, mock_tmux_service):
        ...
        mock_tmux_service.destroy_session.side_effect = mock_destroy_session
    ...
    def test_info_command_not_found(self, runner, mock_tmux_service):
        ...
        mock_tmux_service.get_session_info.side_effect = mock_get_session_info
    ...
    def test_cleanup_command_no_sessions(self, runner, mock_tmux_service):
        ...
        mock_tmux_service.cleanup_sessions.side_effect = mock_cleanup_sessions
    ...
    def test_templates_command(self, runner, mock_tmux_service):
        ...
        templates = {
            "default": LayoutTemplate(
                ...
                windows=[
                    {"name": "main", "command": "bash", "panes": [{"command": "bash"}]}
                ],
            ),
        }
